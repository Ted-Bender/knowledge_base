...
[ORCID iDs](https://orchid.org/) are open and non-proprietary PIDs for authors that can be used by any author free of charge. They are provided by the non-profit organization ORCID Inc.,  providing extended application program interfaces (API) for their members to integrate ORCID services.
